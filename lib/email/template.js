 ...
 * @param {string} options.bodyText - Plain text content for the email body
 */
export function buildEmailText({ heading, bodyText }) {
  return `${heading}
...
Questions? Reply to this email or reach us at destiny@shapeyourdestiny.co`.trim();
}
