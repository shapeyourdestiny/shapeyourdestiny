...
import {
  ...
  createClassWithProgram as createClassWithProgramQuery,
  updateClass as updateClassQuery,
...
export async function createSchoolAction(districtId, name, address = null) {
  const result = await createSchoolQuery(districtId, name, address);
  revalidatePath("/admin/schedule");
  return result;
}
...
export async function createClassWithProgramAction({
  schoolId,
  program,
  days,
  time,
  ...
  const result = await createClassWithProgramQuery({
    schoolId,
    program,
    days,
    time,
...
export async function updateSchoolAction(id, updates) {
  const result = await updateSchoolQuery(id, updates);
  revalidatePath("/admin/schedule");
  return result;
}

export async function updateClassAction(id, updates) {
  const result = await updateClassQuery(id, updates);
  revalidatePath("/admin/schedule");
  return result;
}
...
export async function createHolidayAction(date, name, districtId = null, schoolId = null) {
  const result = await createHolidayQuery(date, name, districtId, schoolId);
  revalidatePath("/admin/schedule");
  return result;
}
